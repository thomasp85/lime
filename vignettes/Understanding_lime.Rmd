...
plot_features(head(explanation, 4), ncol = 1)
```
...
Text explanations are also available through Shine to perform interactive experience.

![Interactive text explanations](../tools/shine_text_explanations.gif){width=700px}
